...
function RPProfileViewer.ShowCharacterInfo(character)
	...
	if (characterData ~= nil) then
		...
		characteristicCount = characteristicCount + SetCharacteristicField(LocalizationHack(characterData["birthsign"]), "RPProfileWindowCharacterPanelXCharacteristicsBirthsignHolder", characteristicCount, 85)
		characteristicCount = characteristicCount + SetCharacteristicField(characterData["residence"], "RPProfileWindowCharacterPanelXCharacteristicsResidenceHolder", characteristicCount, 85)
		characteristicCount = characteristicCount + SetCharacteristicField(characterData["organizations"], "RPProfileWindowCharacterPanelXCharacteristicsOrganizationHolder", characteristicCount, 81)
		characteristicCount = characteristicCount + SetCharacteristicField(characterData["alliances"], "RPProfileWindowCharacterPanelXCharacteristicsAllianceHolder", characteristicCount, 85)
